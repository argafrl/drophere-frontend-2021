...
const ForgotPassword = (props) => {
    ...
    const handleChangeInput = props.handleChange;
    ...
    const requestPasswordRecovery = async (email) => {
      ...
      try {
        ...
        const requestPasswordRecoveryResp = resp.data.data.requestPasswordRecovery;
                    ...
                    <DialogContentText id="alert-dialog-description">
                        { state.success ? 
                            <div className={style['content-container']}>
                                ...
                                <p>Kami telah mengirim link ke <span style={{color: "#2196F3"}}>{state.email}</span> Silahkan periksa email anda untuk instruksi lebih lanjut.</p>
                            </div> 
                            : 
                            <div className={style['content-container']}>
                                <h1>Lupa Password?</h1>
                                ...
                                <div className={style['input-wrapper']}>
                                    ...
                                    style={{borderRadius: '6px', width: '100%', marginBottom: "5px"}}
                ...
                <DialogActions className={style.actions}>
                    ...
                    {state.success ? 
                        ...
                        <div className={style['actions-wrapper']}>
                            ...
                            <Button className={style['button-confirm']} type="primary" autoFocus>
                                Konfirmasi
                            </Button>
                        </div>
                    }
